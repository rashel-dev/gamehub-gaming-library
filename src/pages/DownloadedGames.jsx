...
const DownloadedGames = () => {
    ...
    useEffect(() => {
        document.title = "GameHub | Downloaded Games";
        const loadGamesData = async () => {
            try {
                const response = await fetch("/favourite.json");
        ...
        <div className="min-h-screen bg-base-100">
            ...
            <div className="bg-primary text-primary-content py-16">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Downloaded Games</h1>
                    <p className="text-lg opacity-90 max-w-2xl mx-auto">Your collection of downloaded games.</p>
                </div>
            </div>
